<template>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xs-7">
                <wj-pivot-grid :itemsSource="ng" :isReadOnly=true :initialized="initializePivotGrid" :formatItem="formatItem"></wj-pivot-grid>
            </div>
        </div>
    </div>
</template>
        ...
        methods: {
            ...
            formatItem(s, e) {
                ...
                if (e.panel == this.pivotGrid.cells) {
                    ...
                    let ng = pivotGrid.engine,
                        field = ng.valueFields[e.col % ng.valueFields.length],
                        item = pivotGrid.rows[e.row].dataItem,
                        binding = pivotGrid.columns[e.col].binding,
