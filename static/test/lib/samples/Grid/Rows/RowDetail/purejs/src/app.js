...
function init() {
    ...
    var products = new ODataCollectionView(url, 'Products');
    ...
    var htmlDetail = new FlexGrid('#htmlDetail', {
    ...
    var dpHtml = new FlexGridDetailProvider(htmlDetail, {
    ...
    var gridDetail = new FlexGrid('#gridDetail', {
        autoGenerateColumns: false,
        columns: categoryColumns,
        itemsSource: categories,
        isReadOnly: true
    ...
    var dpGrid = new FlexGridDetailProvider(gridDetail, {
        // use animation when showing details
        isAnimated: true,
        ...
        createDetailCell: function (row) {
            var cell = document.createElement('div');
            var detailGrid = new FlexGrid(cell, {
