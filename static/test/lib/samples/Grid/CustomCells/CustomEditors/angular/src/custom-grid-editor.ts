...
export class CustomGridEditor {
        ...
        this._ctl.addEventListener(this._ctl.hostElement, 'keydown', (e: KeyboardEvent) => {
            switch (e.keyCode) {
                ...
                case wjcCore.Key.Enter:
                    ...
                    let evt = document.createEvent('HTMLEvents') as any;
    ...
    _beginningEdit(grid: wjcGrid.FlexGrid, args: wjcGrid.CellRangeEventArgs) {
        ...
        let rcCell = grid.getCellBoundingRect(args.row, args.col),
        ...
        setTimeout(() => {
            ...
            let input = <HTMLInputElement>this._ctl.hostElement.querySelector('input');
