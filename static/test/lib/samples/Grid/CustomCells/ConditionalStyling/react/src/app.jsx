    ...
    render() {
        return <div className="container-fluid">
                <wjFlexGrid.FlexGrid isReadOnly={true} allowResizing="None" allowDragging="None" allowSorting={false} selectionMode="RowRange" alternatingRowStep={0} initialized={this.initializeGrid} itemsSource={this.state.data}>
                    ...
                    <wjFlexGrid.FlexGridColumn binding="sales" header="Sales" width={80} format="n0"></wjFlexGrid.FlexGridColumn>
                    <wjFlexGrid.FlexGridColumn binding="salesDiff" header="Diff" dataType="Number" width={80} format="p0"></wjFlexGrid.FlexGridColumn>
                    <wjFlexGrid.FlexGridColumn binding="expenses" header="Expenses" width={80} format="n0"></wjFlexGrid.FlexGridColumn>
                    <wjFlexGrid.FlexGridColumn binding="expensesDiff" header="Diff" dataType="Number" width={80} format="p0"></wjFlexGrid.FlexGridColumn>
                </wjFlexGrid.FlexGrid>
            </div>;
    }
}
