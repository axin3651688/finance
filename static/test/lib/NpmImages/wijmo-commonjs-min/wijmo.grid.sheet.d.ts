...
import { Row, Column, CellRange, GridPanel, FlexGrid, DataMap, HitTestInfo, CellFactory, CellType, RowCollection, ColumnCollection, SelectedState } from 'wijmo/wijmo.grid';
 ...
 * <a href="/wijmo/docs/Topics/Grid/FlexSheet/FlexSheet-FomulasFlexSheetFunctions.html">FlexSheet Functions</a>.
 *
 * {@sample Grid/FlexSheet/Bound/purejs Example}
 */
...
export declare class SheetCollection extends ObservableArray {
     ...
     * Overrides the removeAt method of its base class {@link ObservableArray}.
     *
