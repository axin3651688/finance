...
import { Size, CancelEventArgs, Point, Control, DataType, Rect, NotifyCollectionChangedEventArgs, Aggregate, Event, EventArgs, ICollectionView, Tooltip, Binding, IEditableCollectionView, ObservableArray } from 'wijmo/wijmo';
