  ...
  export default {
    ...
    methods:{
        dist(){
            ...
            //         row[i] = []
            //         for(var j in res.data.rows[i]){
            //             row[i].push(res.data.rows[i][j])
            //         }
            //     }          
            //     this.data = row   
            //     localStorage.setItem("a",JSON.stringify(row))   
            //     this.flag = true;
            ...
            let  item = {
                ...
                sql:`SELECT NID,A.DIM_ITEM as xm,B.SNAME AS sk, FACT_BALANCE AS balance, FACT_A AS oneyear, FACT_B AS twoyear, FACT_C AS threeyear, FACT_D AS fouryear,
                    ...
                    WHERE A.DIM_COMPANY='1001010101' AND A.DIM_PERIOD='201812' and A.DIM_ITEM='100101') A  
                    INNER JOIN
            ...
            report(item).then((res)=>{
                ...
                // console.log(this.colHeaders)
                // localStorage.setItem("title",JSON.stringify(res.data.data.data)) 
        ...
        //       var AccuntName = AccountSelect(changes[i][3])
        //       var $container = $("#datatable")
        //       $container.handsontable('setDataAtCell',changes[i][0],4,AccuntName)
        //     }
        ...
        //      if(changes[i][1]==10){
        //       var OrgName = VenEmpSelect(changes[i][3])
        //       var $container = $("#datatable")
        //       $container.handsontable('setDataAtCell',changes[i][0],10,OrgName)
        //     }
        //   }
        // }
