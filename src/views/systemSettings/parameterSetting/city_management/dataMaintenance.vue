            ...
            <el-table-column prop="val" label="数值" width="260" align="right">
                <template slot-scope="scope">
                    ...
                    <!-- <el-input class="data_input" size="small" @change="handleClick(scope)" v-model="scope.row.val" :placeholder="placeholder" :readonly="readonly"> -->
                        <!-- {{scope.row.val|}} -->
                    <!-- </el-input> -->
                    <vue-numeric id="inputId" :class="getClassColor(scope)" ref="numeric" separator="," v-model="scope.row.fact_a" :minus="true" :precision="2" 
                        :read-only="readonly"  ></vue-numeric>
                        <!-- <el-button @click="click(scope)">123</el-button> -->
                </template>
            </el-table-column>
        </el-table>
    </div>
