<template>
    ...
    <div id="cityMaintenance">
        ...
        border>
            ...
            <el-table-column prop="scode" label="公司编码" min-width="260" align="center" sortable></el-table-column>
            <el-table-column prop="sname" label="公司名称" min-width="360" align="left" sortable></el-table-column>
