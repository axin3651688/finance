<template>
    ...
    <div id="groupSetting">
        ...
        border>
            ...
            <el-table-column prop="sname" label="指标名称" width="360" align="left" sortable></el-table-column>
            <el-table-column prop="sdescription" label="说明" align="left" :show-overflow-tooltip="showOverflowTooltip" sortable></el-table-column>
            <el-table-column label="操作" width="160" align="center" sortable>
    ...
    methods: {
        ...
        deleteClick(scope){
            ...
            me.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                ...
                dimIndex_delete(params,"GZW").then(res => {
                    if(res.data.code === 200){
