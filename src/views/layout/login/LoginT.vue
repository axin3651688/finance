<template>
  <el-container class="containerT">
    <el-header class="headerT">
      <el-row>
        <el-col :span="4">
          <div style="height:120px;width:100%;text-align:left;padding-left:100px;">
      ...
      <el-row style="height:100%;">
        <el-col :span="15" style="height:100%;">
          <div style="height:100%;padding-left:100px;">
            <el-carousel indicator-position="outside" :autoplay="true" style="height:100%;">
        ...
        <el-col :span="2" style="height:100%;">
          <div style="height:100%;text-align:center;">
            <div style="height:70%;padding:20% 0;">
